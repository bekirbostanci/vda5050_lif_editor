...
<template>
  <div class="grid gap-2 mt-2">
    ...
    <Input id="nodeId" v-model="props.sideBarNode.newNode.value.nodeId" />
  </div>
  <div class="grid gap-2 mt-2">
    <HoverCard :open-delay="2000">
      <HoverCardTrigger>
    ...
    <Input id="nodeName" v-model="props.sideBarNode.newNode.value.nodeName" />
  </div>
  <div class="grid gap-2 mt-2">
    <HoverCard :open-delay="2000">
      <HoverCardTrigger>
  ...
  <div class="ml-auto flex w-full space-x-2">
    ...
    <div class="grid gap-2 mt-2" v-else>
      ...
      <Input
        ...
        type="number"
        :default-value="0"
        v-model="props.sideBarNode.newNode.value.nodePosition.y"
      />
    </div>
  </div>
  <div class="grid gap-2 mt-2">
